...
extension PaddingExtension on num {
  ...
  EdgeInsetsGeometry get horizontalP => EdgeInsets.symmetric(horizontal: this.toDouble());
  EdgeInsetsGeometry get verticalP => EdgeInsets.symmetric(vertical: this.toDouble());
}
